...
{
	FPaintSectionAreaViewArgs() : bDisplayTickLines(false), bDisplayScrubPosition(false) {}
 ...
 */
class BATTLEXEDITOR_API FTimeSliderController : public ITimeSliderController
{
public:
	FTimeSliderController(const FTimeSliderArgs& InArgs, TWeakPtr<FTimelineController> InEditorTimelineController, TWeakPtr<STimeline> InWeakTimeline, TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface);
