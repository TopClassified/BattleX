...
class FBXDTConnectionDrawingPolicy : public FConnectionDrawingPolicy
{
public:
	FBXDTConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
...
protected:
	TWeakObjectPtr<UEdGraph> GraphObj;
	TMap<TWeakObjectPtr<UEdGraphNode>, int32> NodeWidgetMap;
