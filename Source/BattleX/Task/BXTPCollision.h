...
protected:
	...
	virtual FTransform ComputeSampledHitBoxTransform(const FTransform& BakedPoint, const FTransform& CharMeshWorld, UBXShapeComponent* InShapeComp, const FBXShapeInformation& InShapeInfo);
...
protected:
	...
	virtual FTransform ComputeSampledHitBoxTransform(const FTransform& BakedPoint, const FTransform& CharMeshWorld, UBXShapeComponent* InShapeComp, const FBXShapeInformation& InShapeInfo) override;
