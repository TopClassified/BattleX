...
namespace BXGameplayTags
{
	...
	BATTLEX_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(BXEvent_StartBehavior);
	BATTLEX_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(BXEvent_StopBehavior);
	BATTLEX_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(BXEvent_CastedSkill);
	BATTLEX_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(BXEvent_WillCancelSkill);
	BATTLEX_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(BXEvent_AddedBuff);
	BATTLEX_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(BXEvent_WillRemoveBuff);
